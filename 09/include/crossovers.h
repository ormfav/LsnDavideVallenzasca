...
pair<Individual, Individual> fixHead::operator()(Individual &parent1,
  ...
  for (size_t ip2 = 0, is1 = cut_pos_; is1 < son1.Size(); ++ip2) {
    for (size_t ip1 = cut_pos_; ip1 < parent1.Size(); ++ip1) {
  ...
  for (size_t ip1 = 0, is2 = cut_pos_; is2 < son2.Size(); ++ip1) {
    for (size_t ip2 = cut_pos_; ip2 < parent2.Size(); ++ip2) {
