...
int main(int argc, char *argv[]) {
  ...
  // Direct move
  auto m_drct = [&rnd](point<double, 1> &p) {
  ...
  array<string, 2> path_drct = {"03/out/031-callopt_direct.csv",
                                "03/out/031-putopt_direct.csv"};
  array<string, 2> path_disc = {"03/out/031-callopt_discrete.csv",
                                "03/out/031-putopt_discrete.csv"};
  for (int i = 0; i < 2; ++i) {
