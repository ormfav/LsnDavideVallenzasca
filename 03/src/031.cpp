...
int main (int argc, char *argv[])
{
    ...
    callopt_direct.ProgressiveAverage("03/Data/031-callopt_direct.csv");
    dataBlocks putopt_direct(N_BLOCKS,STEPS_PER_BLOCK, bind(g,rnd));
    putopt_direct.ProgressiveAverage("03/Data/031-putopt_direct.csv");
    
    dataBlocks callopt_discrete(N_BLOCKS,STEPS_PER_BLOCK, bind(h,rnd));
    callopt_discrete.ProgressiveAverage("03/Data/031-callopt_discrete.csv");
    dataBlocks putopt_discrete(N_BLOCKS,STEPS_PER_BLOCK, bind(i,rnd));
    putopt_discrete.ProgressiveAverage("03/Data/031-putopt_discrete.csv");
