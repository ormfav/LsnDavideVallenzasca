...
int main (int argc, char *argv[])
{
    ...
    array<function<double(point<double,1>)>,1> db_eval = {[](point<double,1> p){if(p[0]<=0) return 1; else return 0;}};
    dataBlocks<1,1> pi_circle(STEPS_PER_BLOCK,bind(Throw,placeholders::_1,rnd),db_eval);
